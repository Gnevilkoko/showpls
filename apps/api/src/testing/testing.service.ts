...
import { TopUpController } from "../modules/top-up/top-up.controller"
...
export class TestingService {
  ...
  static async getTopUpModule() {
    return await TestingService.compileModule(
      Test.createTestingModule({
        imports: [
          ...TestingService.getMustHaveModules(),
          TypeOrmModule.forFeature([StarsTopUp, TONTopUp, TONIgnoredTransaction]),
        ],
        providers: [
          TopUpService,
          {
