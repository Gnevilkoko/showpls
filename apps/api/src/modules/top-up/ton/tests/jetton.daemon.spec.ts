...
import { ToncoinDaemon } from "../toncoin/toncoin.daemon"
import { TONIgnoredTransaction, TONTopUp, User } from "@share/entities"
import { TONTopUpService } from "../ton-top-up.service"
import ms from "ms"
import { getJettonDaemonProvider, JettonDaemon } from "../jetton/jetton.daemon"
...
import { getJettonDaemonToken } from "../jetton/get-jetton-daemon-token"
import { UserService } from "../../../user"
import { faker } from "@faker-js/faker/locale/en"

jest.setTimeout(ms("5m"))

describe("JettonDaemon", () => {
  let module: TestingModule
  let dataSource: DataSource
  let service: JettonDaemon
  ...
  beforeEach(async () => {
      ...
      Test.createTestingModule({
        ...
        providers: [
          TONTopUpService,
          {
            ...
            useFactory: async () => {
              return await JettonService.initialize(
    ...
    service = module.get(getJettonDaemonToken(Token.USDT))
  })
