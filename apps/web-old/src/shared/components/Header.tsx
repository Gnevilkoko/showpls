...
import globalTransIcon from '../../assets/global-translate.svg';
import arrowDownTransIcon from '../../assets/arrow-down-translate.svg';
    ...
    <div className="main-header">
      ...
      <div className="header__dropdown-wrapper">
        ...
        >
          ...
          <img
            src={arrowDownTransIcon}
            alt="Arrow Down Icon"
            className={isOpenLang ? 'rotated' : ''}
          />
        </button>

        <ul
          className={`translate-dropdown-menu ${isOpenLang ? 'visible' : ''}`}
        >
