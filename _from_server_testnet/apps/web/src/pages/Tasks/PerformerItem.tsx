...
interface PerformerItemProps {
  ...
  onSendOrder?: (performer: PerformerType) => void
  sendDisabled?: boolean
}

const PerformerItem = ({ performer, ref, handleSelectPerformer, onSendOrder, sendDisabled = false }: PerformerItemProps) => {
