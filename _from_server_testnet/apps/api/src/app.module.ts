...
import { BotLaunchService } from "./modules/bot/bot-launch.service"
...
@Module({
  imports: [
    ...
    TelegrafModule.forRoot({
      ...
      // Автозапуск отключён — см. BotLaunchService (ретраи при недоступности Telegram)
      launchOptions: false,
    }),
    AuthModule,
    RequestModule,
  ...
  providers: [BotHandler, BotLaunchService],
  controllers: [],
  exports: [],
})
